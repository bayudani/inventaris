...
<head>
    ...
    .navbar button {
        ...
        font-size: 16px;
        /* Ensure the font-size is the same for both */
    }
...
<body>
    <div class="navbar">
        ...
        <button class="profile-btn" onclick="location.href='#'">Profil</button>
        <button class="info-btn" onclick="location.href='#'">Informasi</button>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="feature-box">
                    <h3>Fitur Keempat</h3>
                    <p>Deskripsi fitur keempat di sini</p>
                </div>
            </div>
        </div>
    </div>
