...
if (isset($_POST['signup'])) {
    ...
    if ($stmt->execute()) {
        ...
        $signup_error = "Terjadi kesalahan. Silakan coba lagi.";
    }
}
?>
...
<head>
    ...
    <style>
        ...
        .navbar .right-menu .sign-in-btn, .navbar .right-menu .sign-up-btn {
            background-color: #0044cc;
            color: white;
            border: none;
            padding: 10px 20px;
        ...
        .navbar .right-menu .sign-in-btn:hover, .navbar .right-menu .sign-up-btn:hover {
            background-color: #002a80;
        }
        ...
        .info-section, .blog, .terms, .social-media {
            flex: 1 1 250px;
            margin: 10px;
        }

        .info-section h3, .blog h3, .terms h3, .social-media h3 {
            color: white;
        }

        .info-section ul, .blog p, .terms ul, .social-media ul {
            list-style-type: none;
            padding: 0;
        }

        .info-section ul li, .blog p, .terms ul li, .social-media ul li {
            margin-bottom: 10px;
        }
